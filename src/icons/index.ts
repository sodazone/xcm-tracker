...
export function IconPulse() {
  return html`<span
    class=${tw`inline-block animate-pulse w-2 h-3 bg-yellow-400`}
  ></span>`;
}
...
export function IconWait() {
  return html`
    <div class=${tw`flex items-center h-8`}>
      <div
        class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full bg-transparent`}
      >
        <span
          class=${tw`inline-block animate-pulse w-3 h-3 bg-yellow-600 rounded-full`}
        ></span>
      </div>
    </div>
  `;
...
export function IconSuccess() {
  return html`
    <div class=${tw`flex items-center h-8`}>
      <div
        class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full bg-transparent ring-2 ring-green-600`}
      >
        <svg
...
export function IconFail() {
  return html` <div class=${tw`flex items-center h-8`}>
    <div
      class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full bg-transparent ring-2 ring-red-500`}
    >
      <svg
...
export function IconSkipped() {
  return html`
    <div class=${tw`flex items-center h-8`}>
      <div
        class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full bg-transparent ring-2 ring-gray-400`}
      >
        <svg
...
export function IconTimeout() {
  return html`
    <div class=${tw`flex items-center h-8`}>
      <div
        class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full bg-transparent ring-2 ring-yellow-600`}
      >
        <svg
      ...
      return html`
        ...
        >
          ...
          >
            ...
            <g
              id="g1839-4"
              transform="matrix(3.0206892,0,0,3.0206892,-551.86599,-485.64457)"
            >
              <circle
                r="44.846279"
              ...
              <g
                id="g891-6"
                transform="matrix(0.80007833,0,0,0.80007833,45.490514,41.107705)"
              >
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,235.05582,171.98763)"
                  id="g1139-7"
                >
                  <path
                    id="path1141-2"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,194.09364,224.15315)"
                  id="g1143-3"
                >
                  <path
                    id="path1145-4"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,256.85765,215.85431)"
                  id="g1147-8"
                >
                  <path
                    id="path1149-0"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,263.53996,202.25679)"
                  id="g1151-3"
                >
                  <path
                    id="path1153-4"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,242.08858,236.25059)"
                  id="g1155-5"
                >
                  <path
                    id="path1157-5"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,257.77504,229.45183)"
                  id="g1159-4"
                >
                  <path
                    id="path1161-3"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,222.76807,225.18097)"
                  id="g1163-2"
                >
                  <path
                    id="path1165-7"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,197.95105,222.65307)"
                  id="g1167-8"
                >
                  <path
                    id="path1169-4"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,202.71535,203.7566)"
                  id="g1171-6"
                >
                  <path
                    id="path1173-8"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,238.07276,210.96049)"
                  id="g1175-2"
                >
                  <path
                    id="path1177-4"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,191.12581,210.55536)"
                  id="g1179-1"
                >
                  <path
                    id="path1181-5"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,202.71535,217.35412)"
                  id="g1183-7"
                >
                  <path
                    id="path1185-0"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,228.24465,230.95191)"
                  id="g1187-7"
                >
                  <path
                    id="path1189-6"
                ...
                <g
                  transform="matrix(0.22669198,0,0,-0.22669198,212.5583,237.75067)"
                  id="g1191-1"
                >
                  <path
                    id="path1193-1"
...
export function IconChain(id) {
  return html`
    <div class=${tw`flex items-center`}>
      <div
        class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full bg-gray-800 ring-1 ring-gray-800`}
      >
        ${getIconByChainId(id)}
      </div>
    </div>
...
export function IconChainFail(id) {
  return html`<div class=${tw`flex items-center`}>
    <div
      class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full ring-4 ring-red-800`}
    >
      ${IconChain(id)}
    </div>
  </div>`;
...
export function IconChainSuccess(id) {
  return html`<div class=${tw`flex items-center`}>
    <div
      class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full ring-4 ring-green-600`}
    >
      ${IconChain(id)}
    </div>
  </div>`;
...
export function IconChainWait(id) {
  return html`<div class=${tw`flex items-center`}>
    <div
      class=${tw`z-10 animate-pulse flex items-center justify-center w-6 h-6 rounded-full ring-4 ring-yellow-800`}
    >
      ${IconChain(id)}
    </div>
  </div>`;
...
export function IconChainSkipped(id) {
  return html`<div class=${tw`flex items-center`}>
    <div
      class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full ring-4 ring-gray-400`}
    >
      ${IconChain(id)}
    </div>
  </div>`;
...
export function IconChainTimeout(id) {
  return html`<div class=${tw`flex items-center`}>
    <div
      class=${tw`z-10 flex items-center justify-center w-6 h-6 rounded-full ring-4 ring-yellow-600`}
    >
      ${IconChain(id)}
    </div>
  </div>`;
...
export function BadgeType(t: XcmJourneyType) {
  switch (t) {
    case XcmJourneyType.Transfer:
      return html`<span
        class=${tw`text-xs font-medium px-2.5 py-0.5 rounded bg-blue-900 text-blue-300`}
        >${t}</span
      >`;
    case XcmJourneyType.Teleport:
      return html`<span
        class=${tw`text-xs font-medium px-2.5 py-0.5 rounded bg-purple-900 text-purple-300`}
        >${t}</span
      >`;
